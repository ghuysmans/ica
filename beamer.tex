...
\begin{frame}
	...
	certain nombre de V.A.R., la somme de celles-ci se répartit de manière gaussienne. 
	Nous allons donc ici essayer de	faire l'inverse en cherchant des sources non gaussiennes.
...
\begin{frame}
	...
	Si il y a un léger décalage entre les deux mixage,l'algorithme ne fonctionnera pas.
	synchro, clap
	convolution
\end{frame}
